...
TODO: move out to game dev notes

TODO: watch some more..
...
see [text-editors#key-binding concepts and comparison]

TODO: main mappings are in [emacs]
...
very cute 'n simple
  - this is actually the style i'd aim for for textbringer..
    - dead-simple, acii-only (+ acii-art!! <3)

so intuitive, you can guess most key-bindings

worth looking at, to skim for ideas
  - c-e >>> c/m-x (one qwerty key-boards)
  - c-q
    - quit window, if not, the whole program!
      - most editors fail to do this simple thing (emacs, vim, nano?)..
  - c-w
    - cycle windows
      - *feels great!*
  - c-o
  ...
  - c-d
    - *duplicate line*
      - don't really need with copy/paste tho..
  - c-k and c-x (along with standard c-c/v)
    - both ways to cut
  - c-z/y
    - z for undo, y for redo
      - i dunno about this.. i'd rather use shift to denote the opposite action, but it does avoid using shift for bindings entirely (save for selection)
  - c-u/j
    - u to toggle macro recording
    - j to run it
      - i dunno about these either..
  - m-[keys]
      - several bindings for multiple cursors.. hmmm
        - def need an interactive mode here instead..
  - m-[eafb]
      - emacs movement
        - <3
  - c-g
  ...
  - c-h
    - backspace
      - for legacy terminal support.. :/
  - f1/2/4/5/7/10
    - help/save/find/quit/find/quit
      - i dig repeated bindings, lol
        - *f2/3 for save/find are cool..*
  - DONE
    - lol, took only 5 minutes!
       
  - LOVE the ascii tab-line
